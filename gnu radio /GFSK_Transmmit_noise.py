...
class GFSK_Transmmit_noise(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "GFSK_Transmmit_noise", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GFSK_Transmmit_noise")
        ...
        self.settings = Qt.QSettings("GNU Radio", "GFSK_Transmmit_noise")
        ...
        self.configs = configs = {    "noise_1" : {"noise_sensitivity" : 2.8323, "noise_frequency" : 432200000, "noise_bandwidth" : 940000} , "noise_2" : {"noise_sensitivity" : 2.5809, "noise_frequency" : 432500000, "noise_bandwidth" : 860000}, "noise_3": {"noise_sensitivity" : 0.6646, "noise_frequency" : 432800000, "noise_bandwidth" : 250000}}
        ...
        self.digital_gfsk_mod_0_0 = digital.gfsk_mod(
            ...
            log=False,
            do_unpack=True)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/harryh/RADAR-2026/RADAR-SDR/launch/noisekey_package.bin', True, 0, 0)
        ...
        self.connect((self.digital_gfsk_mod_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0_0_0_0_2, 0))
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.noise_frequency, (self.sample_rate*2))
...
def main(top_block_cls=GFSK_Transmmit_noise, options=None):
