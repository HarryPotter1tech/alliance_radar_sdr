...
class GFSK_Receiver_Signal(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "GFSK-Receiver-Signal", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GFSK-Receiver-Signal")
        ...
        self.settings = Qt.QSettings("GNU Radio", "GFSK_Receiver_Signal")
...
def main(top_block_cls=GFSK_Receiver_Signal, options=None):
